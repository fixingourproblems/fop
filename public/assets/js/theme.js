...
var navbarInit = function navbarInit() {
  ...
  if (navbar) {
    ...
    navbar.style.backgroundImage = 'blue'; // Change navbar background color on scroll

    window.addEventListener(Events.SCROLL, function () {
      var scrollTop = html.scrollTop;
      var alpha = scrollTop / windowHeight * 2; // Add class on scroll
      ...
      navbar.style.backgroundImage = alpha > 0 || utils.hasClass(navbarCollapse, 'show') ? backgroundImage : 'blue';
